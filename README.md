# randomClock
I have an issue with waking up on time to go places, so instead I try to set my alarm clocks a little fast so I think that it's later in the morning than it is. Problem is, even if I blindly enter in the minutes, I can still figure out the time.
